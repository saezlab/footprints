...
util$cmp_mut_path("MAPK", c("NRAS", "KRAS", "BRAF"), "Trametinib", "mut")
@
\caption{Trametinib}
...
util$cmp_mut_path("MAPK", c("NRAS", "KRAS", "BRAF"), "AZ628", "mut")
@
\caption{AZ628}
...
util$cmp_mut_path("MAPK", "BRAF", "Dabrafenib", "mut")
@
\caption{Dabrafenib}
...
util$cmp_mut_path("p53", "TP53", "Nutlin-3a", "wt")
@
\caption{Nutlin-3a}
