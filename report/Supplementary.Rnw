...
\Sexpr{knit_child('note_images.Rnw')}

\Sexpr{knit_child('note_searchterms.Rnw')}

\Sexpr{knit_child('note_signatures.Rnw')}

%\Sexpr{knit_child('suppl_notes.Rnw')}
...
\begin{table}[H]
\centering
\caption{Coefficients matrix of the fitted PRG model, provided as a
