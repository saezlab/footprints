...
import('../analyses/speed_overview/plot_bars')$do_plot()
@
...
<<sig_sign, echo=FALSE>>=
kable(import('../analyses/speed_overview/model_significance')$summary(),
      digits=30, booktabs=TRUE)
@
\end{table}
...
@
\caption{Difference in gene sets between Footprints and Gene Ontology/Reactome}
\label{fig:genesets}
\end{figure}
...
\centering
\scalebox{.7}{
<<stability, echo=FALSE, fig.width=5, fig.height=5>>=
import('../analyses/speed_bootstrap/stability_plot')$do_plot('gdsc_matrix.RData')
@
}
