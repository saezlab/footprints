...
<<dataset_size, echo=FALSE, fig.cap='Size of perturbation-response datasets'>>=
overview$do_plot()
@

\subsection{Global Structure of Perturbation Experiments}

<<global_structure, echo=FALSE, fig.cap='Clustering of input experiments'>>=
cluster$do_plot()
@
...
<<perturb_speed_matrix, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Footprint'>>=
util$perturb_score_plots('speed_matrix')
@

<<perturb_go, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Gene Ontology'>>=
util$perturb_score_plots('gsea_go')
@

<<perturb_reactome, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Reactome'>>=
util$perturb_score_plots('gsea_reactome')
@

<<perturb_biocarta, echo=FALSE, fig.height=3, fig.width=8, fig.cap='BioCarta'>>=
util$perturb_score_plots('gsea_biocarta')
@

<<perturb_spia, echo=FALSE, fig.height=3, fig.width=8, fig.cap='SPIA'>>=
util$perturb_score_plots('spia')
@

<<perturb_pathifier, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Pathifier'>>=
util$perturb_score_plots('pathifier')
@

<<perturb_paradigm, echo=FALSE, fig.height=3, fig.width=8, fig.cap='PARADIGM'>>=
...
<<perturb_all, echo=FALSE, fig.cap='ROC curves for input experiments'>>=
roc$do_plot(roc$roc)
@
...
shown in figure [fig:ROC] (AUCs in table [tab:ROC_AUC]). For all pathways
...
<<stability, echo=FALSE, fig.cap='Stability in basal gene expression'>>=
...
<<cor_speed_matrix, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Correlation of Footprint scores'>>=
util$cor_plots('speed_matrix')
@

<<cor_go, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Correlation of Gene Ontology scores'>>=
util$cor_plots('gsea_go')
@

<<cor_reactome, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Correlation of Reactome scores'>>=
util$cor_plots('gsea_reactome')
@

<<cor_speed_biocarta, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Correlation of BioCarta scores'>>=
util$cor_plots('gsea_biocarta')
@

<<cor_spia, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Correlation of SPIA scores'>>=
util$cor_plots('spia')
@

<<cor_pathifier, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Correlation of Pathifier scores'>>=
util$cor_plots('pathifier')
@

<<cor_paradigm, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Correlation of PARADIGM scores'>>=
