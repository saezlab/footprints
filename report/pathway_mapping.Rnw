...
\subfloat[Pathway mapping for Gene Ontology. GO categories (ID and name) shown
...
\subfloat[Pathway mapping for Reactome and Pathifier. Listed are reactome
...
\subfloat[Pathway mapping for SPIA. KEGG pathway IDs and names that SPIA relies
...
\subfloat[Pathway mapping for PARADIGM. This method is different as it performs
...
\subfloat[Pathway mapping for the signatures published and validated in Gatza et al. (2009)]{
\begin{tabular}{cc}
\hline
