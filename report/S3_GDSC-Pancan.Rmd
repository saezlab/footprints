...
mapk_mut_pathway = util$mapk_mut_pathway(scores, mut, "MAPK", c("BRAF", "NRAS", "KRAS"))
mapk_braf_pathway = util$mapk_mut_pathway(scores, mut, "MAPK", "BRAF")
p53_mut_pathway = util$p53_mut_pathway(scores, mut, "p53", "TP53")
```
