...
```{r dataset_size, echo=FALSE, fig.cap='Size of perturbation-response datasets'}
overview$do_plot()
```

## Global Structure of Perturbation Experiments

```{r global_structure, echo=FALSE, fig.cap='Clustering of input experiments'}
cluster$do_plot()
```
...
```{r perturb_speed_matrix, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Footprint recall'}
util$perturb_score_plots('speed_matrix')
```

### Gene Ontology

```{r perturb_go, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Gene Ontology recall'}
util$perturb_score_plots('gsea_go')
```

### Reactome

```{r perturb_reactome, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Reactome recall'}
util$perturb_score_plots('gsea_reactome')
```

### BioCarta

```{r perturb_biocarta, echo=FALSE, fig.height=3, fig.width=8, fig.cap='BioCarta recall'}
util$perturb_score_plots('gsea_biocarta')
```

### SPIA

```{r perturb_spia, echo=FALSE, fig.height=3, fig.width=8, fig.cap='SPIA recall'}
util$perturb_score_plots('spia')
```

### Pathifier

```{r perturb_pathifier, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Pathifier recall'}
...
```{r perturb_paradigm, echo=FALSE, fig.height=3, fig.width=8, fig.cap='PARADIGM recall'}
...
```{r perturb_all, echo=FALSE, fig.cap='ROC curves for input experiments'}
roc$do_plot()
```

## Stability of Scores in Basal Expression

```{r stability, echo=FALSE, fig.cap='Stability in basal gene expression'}
...
```{r cor_speed_matrix, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Correlation of Footprint scores'}
util$cor_plots('speed_matrix')
```

### Gene Ontology

```{r cor_go, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Correlation of Gene Ontology scores'}
util$cor_plots('gsea_go')
```

### Reactome

```{r cor_reactome, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Correlation of Reactome scores'}
util$cor_plots('gsea_reactome')
```

### BioCarta

```{r cor_speed_biocarta, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Correlation of BioCarta scores'}
util$cor_plots('gsea_biocarta')
```

### SPIA

```{r cor_spia, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Correlation of SPIA scores'}
util$cor_plots('spia')
```

### Pathifier

```{r cor_pathifier, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Correlation of Pathifier scores'}
util$cor_plots('pathifier')
```

### PARADIGM

```{r cor_paradigm, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Correlation of PARADIGM scores'}
