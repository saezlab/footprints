...
```{r perturb_speed_matrix, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Footprint'}
util$perturb_score_plots('speed_matrix')
```

```{r perturb_go, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Gene Ontology'}
util$perturb_score_plots('gsea_go')
```

```{r perturb_reactome, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Reactome'}
util$perturb_score_plots('gsea_reactome')
```

```{r perturb_biocarta, echo=FALSE, fig.height=3, fig.width=8, fig.cap='BioCarta'}
util$perturb_score_plots('gsea_biocarta')
```

```{r perturb_spia, echo=FALSE, fig.height=3, fig.width=8, fig.cap='SPIA'}
util$perturb_score_plots('spia')
```

```{r perturb_pathifier, echo=FALSE, fig.height=3, fig.width=8, fig.cap='Pathifier'}
util$perturb_score_plots('pathifier')
```

```{r perturb_paradigm, echo=FALSE, fig.height=3, fig.width=8, fig.cap='PARADIGM'}
