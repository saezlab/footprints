...
#### MEK inhibitors and MAPK activity

```{r nums1, echo=FALSE}
sapply(MEKi_MAPK, length)
```

#### BRAF inhibitors and MAPK activity

```{r nums2, echo=FALSE}
sapply(BRAFi_MAPK, length)
```

#### Nutlin-3a and p53 activity

```{r nums3, echo=FALSE}
sapply(Nutlin_p53, length)
```
...
methods = c("mutation", "speed_matrix", "gsea_reactome", "gsea_go")
