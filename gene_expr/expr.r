...
#TODO: do assocs w/ corrected expr, if not different use this for everything
#  should also derive clusters from this object (speed2/cluster dir)
#  maybe: show that batch correction does not influence scores (x vs y plot)
