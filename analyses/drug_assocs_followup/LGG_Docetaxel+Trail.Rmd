---
title: "LGG drug associations for perturbation-response genes"
...
tissues = gdsc$tissues("LGG")
Yf = gdsc$drug_response('IC50s', tissue="LGG", min_tissue_measured=2, median_top=10, drop=TRUE)
...
```{r range, echo=FALSE}
lgg_trail = scores[names(tissues), "Trail"]
stratify = list(LGG = list(
    "LGG_Trail+" = names(lgg_trail)[lgg_trail > 0],
    "LGG_Trail-" = names(lgg_trail)[lgg_trail < 0]
))

gdsc$plot$drug_range_box("Docetaxel", stratify=stratify)
```
...
print(do_fit("LGG", "Docetaxel", "Trail", "Trail expression"))
#print(do_fit("LGG", "Docetaxel", "Trail", "CASP8"))
#print(do_fit("LGG", "Docetaxel", "Trail", "CASP10"))
#print(do_fit("LGG", "Docetaxel", "Trail", "FADD"))
#print(do_fit("LGG", "Docetaxel", "Trail", "TNFRSF10A"))
#print(do_fit("LGG", "Docetaxel", "Trail", "TNFRSF10B"))
#print(do_fit("LGG", "Docetaxel", "Trail", "TNFSF10"))
```

Expression of Trail-induced genes (on horizontal axis) are
correlated with drug sensitivity in Low-Grade Glioma (LGG),
...
Taken together, we find a possible synergy between rTrail and Docetaxel
as treatment in LGG.
